...
export default function EmployeePage() {
  ...
  useEffect(() => {
    ...
    void api.recommendations(employeeId).then((items) => {
      ...
      if (!cancelled) setRecommendationsError(cause instanceof Error ? cause.message : 'Не удалось подобрать шаги. Попробуйте ещё раз чуть позже.');
