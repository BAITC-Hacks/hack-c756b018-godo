  ...
  return <MotionConfig reducedMotion="user"><div className="app-shell">
    ...
    <aside className="sidebar">
      ...
      <nav aria-label="Основная навигация" className="mt-6 space-y-2">
        ...
        <Link href="/hr" aria-label="Развитие команды" aria-current={pathname === '/hr' ? 'page' : undefined} className={`side-link ${pathname === '/hr' ? 'active' : ''}`}><ChartNoAxesCombined size={18} /><span className="sidebar-label">Развитие команды</span></Link>
      </nav>
